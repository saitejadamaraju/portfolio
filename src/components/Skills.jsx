...
const Skills = ()=>
    {
        ...
        return(
            ...
            <div className="text-white m-1">
                <div className="flex">
                    <h2 className="text-3xl font-extrabold m-1">Tech Stack</h2>
                    <img className="pl-1" src={techstack}></img>
                </div>
                  
                <div className="flex flex-wrap h-[350px] sm:h-[350px] md:h-[350px] overflow-auto justify-center">
                    <div className=" w-[300px] h-[250px] sm:w-[350px] sm:h-[300px] md:w-[400px] md:h-[350px] bg-gray-800 m-1 rounded-md">
                        ...
                        <span 
                            ...
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={reacticon} alt="React Icon"></img></span>
                            {hovered === "reactjs" && 
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={tailwindcss} alt="React Icon"></img></span>
                            {hovered === "tailwindcss" && 
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={html} alt="React Icon"></img></span>
                            {hovered === "html" && 
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={javascript} alt="React Icon"></img></span>
                            {hovered === "javascript" && 
                    ...
                    <div className=" w-[300px] h-[250px] sm:w-[350px] sm:h-[300px] md:w-[400px] md:h-[350px] bg-gray-800 m-1 rounded-md">
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={springboot} alt="React Icon"></img></span>
                            {hovered === "springboot" && 
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={java} alt="React Icon"></img></span>
                            {hovered === "java" && 
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={postgresql} alt="React Icon"></img></span>
                            {hovered === "postgresql" && 
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={nodejs} alt="React Icon"></img></span>
                            {hovered === "nodejs" && 
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={expressjs} alt="React Icon"></img></span>
                            {hovered === "expressjs" && 
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={mongodb} alt="React Icon"></img></span>
                            {hovered === "mongodb" && 
                    ...
                    <div className=" w-[300px] h-[250px] sm:w-[350px] sm:h-[300px] md:w-[400px] md:h-[350px] bg-gray-800 m-1 rounded-md">
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={python} alt="React Icon"></img></span>
                            {hovered === "python" && 
                        ...
                        <span 
                            ...
                            onMouseLeave={()=>{setHovered(null)}} 
                            className="p-1 cursor-pointer relative">
                                <span><img className="h-[50px] md:h-[75px] m-4" src={clang} alt="React Icon"></img></span>
                            {hovered === "clang" && 
